...
<body style="background-color:black; display:flex; flex-direction:column; align-items:center; width:100vw;">
    ...
    <div style="background-color:gray; border-style:none; border-radius:10px; text-align:center; padding:1.5vw; font-family:Arial; font-size:1.2vw;">Se ha registrado con éxito <br><a style="color:#f9e8b2;" href="login.html">Ir al login</a></div>
</body>
</html>