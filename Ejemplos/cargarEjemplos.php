...
$query = file_get_contents("usuariosEjemplo.sql").file_get_contents("ejerciciosEjemplo.sql").file_get_contents("calificacion.sql").file_get_contents("cronograma.sql").file_get_contents("deportes.sql").file_get_contents("sede.sql");
